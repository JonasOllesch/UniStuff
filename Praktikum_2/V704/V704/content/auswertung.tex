...
Der der Theoriewert wird wieder mit den Gleichungen \eqref{eq:wirkungsquercompton} und  \eqref{eq:absorptionskoefftheorie} bestimmt und beträgt% Hast du den Theoriewert irgendwo?

\begin{equation*}
    \mu_{\text{theo-Cu}} = 63,2  \, \dfrac{1}{\unit{\meter}} \, .%sorry, aber ich habe echt keine Ahnung wie man den berechnen soll, deswegen habe ich den aus dem Altprotokoll geklaut und wenn man die Avogadro-Konstante verwendet anstelle dieser anderen Zahl ist das kein Problem mehr.
