...
% Ne gibt es da denn überhaupt einen. Da hätte man doch das Gewicht der Apperatur und so messen müssen...
\begin{figure}[H]
  \centering
...
\begin{equation*}
  \left|\frac{I_{K,m}}{I_{K,t}} * 100 - 100 \right| = (4 \pm 13) \% \,. %wenn ich die mit dem GTR berechne kommt da irgendwas mit 5 raus ...
\end{equation*}
...
\begin{table}[H]
  ...
  \begin{tabular}{S[table-format=2.0] S[table-format=2.2]}
      ...
      \midrule
        {Kopf}  & {$0.04310 \pm 0.00010$} \\ % Das hier KANN nicht stimmen, da müssen wir nochmal gucken :D
        {Arme}  & {$0.12920 \pm 0.00010$} \\ % Das hier KANN nicht stimmen, da müssen wir nochmal gucken :D
        {Torso} & {$0.08740 \pm 0.00010$}\\ % Das hier KANN nicht stimmen, da müssen wir nochmal gucken :D
        {Beine} & {$0.14630 \pm 0.00010$} \\ % Das hier KANN nicht stimmen, da müssen wir nochmal gucken :D
      \bottomrule
  \end{tabular}
...
\begin{table}[H]
  ...
  \begin{tabular}{S[table-format=2.0] S[table-format=1.3] S}
      ...
      \bottomrule
  \end{tabular}
  \caption{Schwingungsdauern bei Auslenkungen von $\varphi = 90 \unit{\degree}$ und $\varphi = 120 \unit{\degree}$.}
  \label{tab:Messung_f}
\end{table}
...
\begin{equation*}
  I_{P_1} = (0.000219 \pm 0.000029) \, \unit{\newton\meter} \,.
\end{equation*}
...
Die Arme sind je um $R_{Arme} + R_{Torso}$, die Beine um je $R_{Beine}$ zur Drehachse verschoben. Über den Satz von Steiner lassen sich jetzt die dazugehörigen Trägheitsmomente berechnen.
Dabei sind die Beine vertikal und die Arme horizontal zur Drehachse verschoben. 
Es ergeben sich mithilfe der Zylinderträgheitsmomente aus \autoref{fig:trägmomSKZ}
\begin{equation*}
  I_{Arme,t} = I_{Arme,S} + m a^2 = m (\frac{R^2_{Arme}}{4} + \frac{h^2_{Arme}}{12}) + m (R_{Torso} + R_{Arme})^2 = ... \, \unit{\newton\meter}
\end{equation*}
und
\begin{equation*}
