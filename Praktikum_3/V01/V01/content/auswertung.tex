...
\begin{figure}[H] 
    ...
    \caption{Aufgenommene Zählrate bei Änderung der Verzögerungsleitung für eine Pulsdauer von $t_\text{Koin} = 10 \, \unit{\nano\second}$.}
    \label{fig:koin_10}
\end{figure}
...
\begin{figure}[H] 
    ...
    \caption{Aufgenommene Zählrate bei Änderung der Verzögerungsleitung für eine Pulsdauer von $t_\text{Koin} = 15 \, \unit{\nano\second}$.}
    \label{fig:koin_15}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Aufgenommene Zählrate bei Änderung der Verzögerungsleitung für eine Pulsdauer von $t_\text{Koin} = 20 \, \unit{\nano\second}$.}
    \label{fig:koin_20}
\end{figure}
