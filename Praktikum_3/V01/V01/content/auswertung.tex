...
\begin{figure}[H]
    ...
    \caption{Lineare Regression durch die Kanäle des MCA und die dazugehörenden Zeiten bei einer Impulsbreite von $\Delta t = 10 \,\unit{\nano\second}$.}
    \label{fig:koin_10}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Lineare Regression durch die Kanäle des MCA und die dazugehörenden Zeiten bei einer Impulsbreite von $\Delta t = 15 \,\unit{\nano\second}$.}
    \label{fig:koin_15}
\end{figure}
...
\begin{figure}[H]
    ...
    \caption{Lineare Regression durch die Kanäle des MCA und die dazugehörenden Zeiten bei einer Impulsbreite von $\Delta t = 20 \,\unit{\nano\second}$.}
    \label{fig:koin_20}
\end{figure}
