...
\begin{table}[H]
    ...
    \midrule
        $10$&  $20,250 \pm 0,665$ &  $17,891$ & $2,109$\\ %%%%%%%%%%%%%%%%%%%%%% Hier noch die Kommastellen
        $15$&  $24,871 \pm 1,775$ &  $22,855$ & $7,145$\\ %%%%%%%%%%%%%%%%%%%%%% Hier noch die Kommastellen
        $20$&  $21,628 \pm 1,260$ &  $40,831$ & $0,831$\\ %%%%%%%%%%%%%%%%%%%%%% Hier noch die Kommastellen
    \bottomrule
    \end{tabular}
    \end{table}

\begin{figure}[H] %%%%%%%%%%%%%%%%%% Noch die Beschriftungen der y-Achse der Plots. Auf wie viele Sekunden hast du das runtergerechnet? Eigentlich sollte das doch eine Zählrate sein, oder?
    \centering
...
Der Untergrund verteilt sich auf $511$ Kanäle. Dadurch folgt eine Untergrundrate von $B_\text{theo} = 1,239$. %%% Warum haben wir hier die 511 statt 512?
