...
\exercise{Quarksalat(10P)}
    ...
    \begin{enumerate}
        ...
        \solution{Vektor-Axialvektor bedeutet, dass die schwache Wechselwirkung nur an linkshändigen Teilchen koppelt. Mathematisch ist $\left( 1 - \gamma^5 \right)$ der linkshändige Projektor, der dazu führt, dass Parität maximal gebrochen wird.}
        ...
        \item Zeichnen Sie das Feynman-Diagramm, das den Zerfall des $\mu^-$ auf Tree-Level beschreibt.
        \solution{
        \begin{tikzpicture}
            \begin{feynman}
              \vertex (a) {\(\mu^{-}(p_1)\)};
