...
\subsection{Einschränkungen durch Neutrinospektren}
...
Durch die Näherung $\theta_{1 3} = 0$ findet nur eine Mischung zwischen Elektron- und Myonneutrinos statt, der Mischungswinkel $\theta_m$ lässt sich also mit $\theta_\odot$ identifizieren.
...
Diese Einschränkung werden wir später nutzen, um einen sinnvollen Cutoff in den erstellten Plots zu erhalten. 
