...
Als Zeitpunkte wurden dienen dabei $t_i = 380i$ mit $i \in [1,4]$.
...
\begin{table}[H]
  ...
  \begin{tabular}{S S S}
    ...
    \midrule
    {$t_1$} & {$0.02139 \pm 0.00035$} \\
    {$t_2$} & {$0.01769 \pm 0.00042$} \\
    {$t_3$} & {$0.01398 \pm 0.00050$} \\
    {$t_4$} & {$0.01027 \pm 0.00061$} \\
    \bottomrule
  \end{tabular}
\end{table}
...
Damit der Massendurchsatz mit Formel \eqref(eq:Massendurch) berechnet werden kann muss zunächst die Vermapfungswärme $L$ bestimmt werden.
