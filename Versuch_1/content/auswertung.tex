...
\begin{table}[H]
  ...
  \begin{tabular}{S S S}
    ...
    \midrule
    {$\bar{T}_1 \mathbin{/} \unit{\second}$} & 1.653 & 1.984\\
    {$σ_{T_1}   \mathbin{/} \unit{\second}$}   & 0.0137 & 0.0327\\
    {$ΔT_1      \mathbin{/} \unit{\second}$}      & { \pm 0.014}& {\pm 0.033}\\
    {$\bar{T}_2 \mathbin{/} \unit{\second}$} & 1.689 & 1.984 \\
    {$σ_{T_2}   \mathbin{/} \unit{\second}$}   & 0.0385 & 0.0227\\
    {$ΔT_2      \mathbin{/} \unit{\second}$}      & {\pm 0.038} & {\pm 0.023}\\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{S S S}
    ...
    & {$l=70 \, \unit{\centi\meter}$} & { $l=100 \, \unit{\centi\meter}$} \\
    \midrule
    {$\bar{T}_+ \mathbin{/} \unit{\second}$} & 1.7025 & 1.9781\\
    {$σ_{T_+}   \mathbin{/} \unit{\second}$}   & 0.0619 & 0.0303\\
    {$ΔT_+      \mathbin{/} \unit{\second}$}      & {\pm 0.062} & {\pm 0.030}\\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{S S S}
    ...
    & {$l=70 \, \unit{\centi\meter}$} & { $l=100 \, \unit{\centi\meter}$} \\
    \midrule
    {$\bar{T}_- \mathbin{/} \unit{\second}$} & 1.526 & 1.847\\
    {$σ_{T_-}   \mathbin{/} \unit{\second}$}   & 0.0571 & 0.0369\\
    {$ΔT_-      \mathbin{/} \unit{\second}$}      & {\pm 0.0570} & {\pm 0.0370}\\
    \bottomrule
  \end{tabular}
\end{table}
...
\begin{table}[H]
  ...
  \begin{tabular}{S S[table-format=2.2] S[table-format=2.2]}
    ...
    & {$l=70 \, \unit{\centi\meter}$} & { $l=100 \, \unit{\centi\meter}$} \\
    \midrule
    {$\bar{T}   \mathbin{/} \unit{\second} $} & 1.539 & 1.887 \\
    {$σ_{T}     \mathbin{/} \unit{\second} $}   & 0.0718 & 0.04710\\
    {$ΔT        \mathbin{/} \unit{\second} $}      & {\pm 0.072} &{\pm 0.047}\\
    {$\bar{T}_S \mathbin{/} \unit{\second} $} & 17.823 & 27.794 \\
    {$σ_{T_S}   \mathbin{/} \unit{\second} $}   & 0.5799 & 0.4448 \\
    {$ΔT_S      \mathbin{/} \unit{\second} $}      & {\pm 0.580} &{\pm 0.440}\\
    \bottomrule
  \end{tabular}
\end{table}
...
\end{align}
über die Berechnung mit den Mittelwerten der Periodendauern ergeben sich die Messfrequenzen.
...
Mit \eqref{eq:Kopplungsgrad} lässt sich abschließend noch der Kopplungsgrad der Federn berechnen.
So ergibt
\begin{equation}
